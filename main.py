...
b_num, a_num =  H.coeffs(component_values, scheme=None, combination='parallel')
b_num_dig, a_num_dig =  H.coeffs(values=component_values, scheme='bckwrd', Fs= Fs, combination='parallel')
